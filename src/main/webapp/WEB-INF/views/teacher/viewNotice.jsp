				...
				<div class="container">
					...
					<div class="mb-3">
						<div class="row">
							...
							<c:choose>
								<c:when test="${notice.noticeWriter eq name}">
									<div class="col-md-auto mb-3">
										<input type="button" class="btn btn-primary" onclick="location.href='${context}/teacher/notice/${notice.noticeId}/update'" value="글 수정" />
									</div>
									<div class="col-md-auto mb-3">
										<form action="${context}/teacher/notice/${notice.noticeId}/remove" method="POST">
											<input type="submit" class="btn btn-primary" value="글 삭제">
										</form>
									</div>
								</c:when>
							</c:choose>
