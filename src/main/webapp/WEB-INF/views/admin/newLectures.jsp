		...
		<div id="content-wrapper" class="d-flex flex-column">
			...
			<div class="container-fluid">
				...
				<div class="d-sm-flex align-items-center justify-content-between mb-4">
					<h2 class="h2 mb-0 text-gray-800">강의 관리 > 강의 생성</h2>
				</div>
				<hr>
				<div class="container">
					<div class="input-form-backgroud row">
						<div class="input-form col-md-12 mx-auto">
							<h4 class="mb-3">강의 생성</h4>
							<form action="${context}/admin/lectures/new" method="post" class="validation-form" novalidate>
								<div class="row">
									<div class="col-md mb-3">
										<label for="lectureName">과정 명</label> 
 								...
 								<div class="row">
									<div class="col-md-6 mb-3 mt-3">
										<label for="lectureStart">개강 일</label>
										<input type="text" id="lectureStart" class="form-control" name="lectureStart">
									</div>
								
									<div class="col-md-6 mb-3 mt-3">
										<label for="lectureEnd">종강 일</label>
										<input type="text" id="lectureEnd" class="form-control" name="lectureEnd">
									</div>		
								</div>
								...
								<div class="mb-3">
									...
									<div class="form-check form-check-inline">
										...
										<label class="form-check-label" for="weekend">주말</label>
										 &nbsp
										<div class="col">
											<input type="text" class="form-control" name="lectureTime" id="lectureTime" placeholder="09:00 ~ 18:00">
										</div>
									</div>

									<div class="row">
										<div class="col-md-4 mb-3 mt-3">
											<label for="lectureTeacher">강사</label>
											<input type="text" class="form-control" id="lectureTeacher" name="lectureTeacher">
										</div>
										<div class="col-md-4 mb-3 mt-3">
											<label for="lectureRoom">강의실</label>
											<select class="custom-select d-block w-100" id="lectureRoom" name="lectureRoom">
												<option>1 강의실</option>
												<option>2 강의실</option>
												<option>3 강의실</option>
											</select>
										...
										<div class="col-md-4 mb-3 mt-3">
											...
											<input type="text" class="form-control" id="lecturePeople" name="lecturePeople">
										</div>
									</div>
