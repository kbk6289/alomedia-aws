		...
		<div id="content-wrapper" class="d-flex flex-column">
			...
			<div class="container-fluid">
				...
				<div
					...
					<h1 class="h2 mb-0 text-gray-800">내 정보 수정</h1>
				</div>
				<hr>
				<div class="container">
					<div class="input-form-backgroud row">
						<div class="input-form col-md-12 mx-auto">
							<form class="validation-form" name="member" method="POST"
								...
								<div class="mb-3">
									<label for="passwordTwo" class="col-form-label">비밀번호
										재입력</label> <input type="password" class="form-control"
										id="passwordTwo" name="passwordTwo" required>
									<div class="invalid-feedback">비밀번호를 입력해주세요.</div>
								</div>
								<div class="mb-3">
									<label for="birth" class="col-form-label">생년월일</label> <input
										type="text" class="form-control" id="birth" name="birth"
										value="${member.birth}" required readonly>
								</div>
								<div class="mb-3">
									<label for="gender" class="col-form-label">성별</label> <input
										type="text" class="form-control" id="gender" name="gender"
										value="${member.gender}" required readonly>
								</div>

								<div class="mb-3">
									<label for="phone" class="col-form-label">휴대폰</label> <input
										type="text" class="form-control" id="phone" name="phone"
										value="${member.phone}" required readonly>
								</div>
								<div class="mb-3">
									<label for="address" class="col-form-label">주소</label> <input
								...
								<div class="mb-3">
									<label for="mail" class="col-form-label">이메일</label> <input
										type="email" class="form-control" id="mail" name="mail"
										value="${member.mail}" required>
