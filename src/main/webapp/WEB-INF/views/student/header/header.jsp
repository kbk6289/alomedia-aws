...
<%
    ...
    if (Loginsession == null || Loginsession.getAttribute("name") == null || !Loginsession.getAttribute("userType").equals("수강생")) {
...
<header class="p-3 text-bg-dark">
    <div class="container">
        <div style="position: absolute; right: 10px">
        	<span style="position: relative; right: 10px">수강생 ${name}님</span>
