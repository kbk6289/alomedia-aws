			...
			<div class="container-fluid">
						...
						<tbody>
							<c:forEach var="adminNotice" items="${adminNotices}">
								<tr class="table-secondary">
									...
									<td style="font-weight: bolder"><a
										href="${context}/student/notice/${adminNotice.noticeId}">${adminNotice.noticeName}</a></td>
							...
							<c:forEach var="notice" items="${notices}">
								<tr>
									...
									<td><a href="${context}/student/notice/${notice.noticeId}">${notice.noticeName}</a></td>
				...
				<div class="container">
					<div class="input-form col-md-12 mx-auto">
						<form action="${context}/student/notice/search" method="get">
					...
					<ul class="pagination">
						<c:if test="${currentPage > 1}">
							<li class="page-item"><a class="page-link"
								href="${context}/student/notice/search/?page=${currentPage - 1}&type=${param.type}&keyword=${param.keyword}"
								aria-label="Previous"><span aria-hidden="true">&laquo;</span></a></li>
						</c:if>
						<c:forEach var="pageNum" begin="1" end="${totalPages}">
							<li
								class="page-item <c:if test="${pageNum == currentPage}">active</c:if>">
								<a class="page-link"
								href="${context}/student/notice/search/?page=${pageNum}&type=${param.type}&keyword=${param.keyword}">${pageNum}</a>
							</li>
						</c:forEach>
