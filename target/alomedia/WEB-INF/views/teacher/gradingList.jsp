		...
		<div id="content-wrapper" class="d-flex flex-column">
			...
			<div class="container-fluid">
				...
				<div class="d-sm-flex align-items-center justify-content-between mb-4">
					<h2 class="h2 mb-0 text-gray-800">평가 관리 > 평가 채점</h2>
				</div>
				<div>
						...
						<table class="table">
							...
							<tbody>
								<c:forEach var="submitList" items="${submitLists}">
									<tr>
										<td>${submitList.name}</td>
										<td>${submitList.submitTime}</td>
										<c:choose>
											<c:when test="${submitList.state == '미채점'}">
												<td><a href="${context}/teacher/exam/${submitList.examId}/student/${submitList.id}">진행중</a></td>
												<td>미채점</td>
											</c:when>
											<c:otherwise>
												<td><a href="${context}/teacher/exam/${submitList.examId}/student/${submitList.id}">채점 / 수정</a></td>
