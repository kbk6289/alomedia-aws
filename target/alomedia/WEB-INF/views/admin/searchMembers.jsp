				...
				<nav aria-label="Page navigation example">
					<ul class="pagination">
						<c:if test="${currentPage > 1}">
							<li class="page-item"><a class="page-link" href="${context}/admin/members/search/?page=${currentPage - 1}&type=${param.type}&keyword=${param.keyword}" aria-label="Previous"><span
									aria-hidden="true">&laquo;</span></a></li>
						</c:if>
						<c:forEach var="pageNum" begin="1" end="${totalPages}">
							<li class="page-item <c:if test="${pageNum == currentPage}">active</c:if>"><a class="page-link"
								href="${context}/admin/members/search/?page=${pageNum}&type=${param.type}&keyword=${param.keyword}">${pageNum}</a></li>
						</c:forEach>
						<c:if test="${currentPage < totalPages}">
							<li class="page-item"><a class="page-link" href="${context}/admin/members/search/?page=${currentPage + 1}&type=${param.type}&keyword=${param.keyword}" aria-label="Next"><span
